...
Our initial datasets are .. and ![TRACE Emissions Dataset](https://climatetrace.org/data). 
For TRACE dataset, we have taken "Agriculture" sector CO2-equivalent emission within the last 100 years.
